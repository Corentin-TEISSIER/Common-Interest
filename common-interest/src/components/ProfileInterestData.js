...
class ProfileInterestData extends React.Component {
        ...
        return <div className="profile-interest-data-background">
            <div className="interests-major-part">
                {majorDoublet.map( interestDoublet => (
                    <div className="major-line-container">
                        <InterestTile speciality={interestDoublet.left.speciality} level={interestDoublet.left.level} user={this.props.user}  setUserInterestsState={this.props.setUserInterestsState}/>
                        <InterestTile speciality={interestDoublet.right.speciality} level={interestDoublet.right.level} user={this.props.user}  setUserInterestsState={this.props.setUserInterestsState}/>
                    </div>
                ))}
            </div>
            <div className="profile-user-interests-last-line">
                <div className="interests-minor-part">
                    {minor.map( interest => (
                        <InterestTile speciality={interest.speciality} level={interest.level} user={this.props.user} setUserInterestsState={this.props.setUserInterestsState}/>
                    ))}
                </div>
                <AddInterestTile />
            </div>
...
export default ProfileInterestData;